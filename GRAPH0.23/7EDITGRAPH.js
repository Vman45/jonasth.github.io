...
for (var t = 0; t < marklist.length - 1; t++) {
    ...
    for (var s = 1 + x; s < marklist.length; s++) {
     nextnode = marklist[s];
     x++;
     arr[currentnode].BcurveX1[nextnode]=arr[currentnode].rposX+20;
     arr[currentnode].BcurveX2[nextnode]=arr[currentnode].rposX+60;
        //z=z+20;
     arr[currentnode].BcurveY1[nextnode]=arr[currentnode].rposY+z;
     arr[currentnode].BcurveY2[nextnode]=arr[currentnode].rposY+z;

     arr[nextnode].BcurveX1[currentnode]=arr[nextnode].rposX+100;
     arr[nextnode].BcurveX2[currentnode]=arr[nextnode].rposX+140;
     arr[nextnode].BcurveY1[currentnode]=arr[nextnode].rposY+z;
     arr[nextnode].BcurveY2[currentnode]=arr[nextnode].rposY+z;
...
function bezier_fetch() {
    for (var t = 0; t < arr.length; t++) {
        var blength=arr[t].BcurveX1.length;
        for (var s=0;s<blength;s++){
        if (mouseDown.x >= arr[t].BcurveX1[s] && mouseDown.x <= (arr[t].BcurveX1[s] + 20) && mouseDown.y >= arr[t].BcurveY1[s] && mouseDown.y <= (arr[t].BcurveY1[s] + 20)) {
            beziernode=t;
            bezierlink=s;
            holdbezier1=true;
        } else if  (mouseDown.x >= arr[t].BcurveX2[s] && mouseDown.x <= (arr[t].BcurveX2[s] + arr[t].rwidth) && mouseDown.y >= arr[t].BcurveY2[s] && mouseDown.y <= (arr[t].BcurveY2[s] + arr[t].rheigth)) {
            beziernode=t;
            bezierlink=s;
            holdbezier2=true;
        }
